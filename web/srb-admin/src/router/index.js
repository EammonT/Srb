...
export const constantRoutes = [
  ...
  },
  {
    ...
    alwaysShow: true, //  false当且仅当父节点只有一个子节点时，不显示父节点,true 任何时候都显示父节点
    children: [
      {
        path: 'list',
        name: 'coreIntegralGradeList', //  每个name不能相同
        component: () => import('@/views/core/integral-grade/list'),
        meta: { title: '积分等级列表', icon: 'el-icon-s-operation' }
      },
      {
        path: 'create',
      ...
      {
        path: 'edit/:id', // :id表示一个占位符，表示这部分url会是任何一个id
